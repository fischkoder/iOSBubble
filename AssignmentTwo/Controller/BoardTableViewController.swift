...
class BoardTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "scoreItem", for: indexPath) as! ScoreTableViewCell
        let records = rankingArray[indexPath.row]
        cell.playerName.text = records.key
        cell.highScore.text = String(records.value)
